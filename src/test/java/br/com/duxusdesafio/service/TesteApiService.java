...
public class TesteApiService {
    ...
    /*Realizando cobertura de possíveis acontecimentos no TimeDaData*/

    //Teste data não existe
    @Test
    public void deveRetonarNuloQuandoDataNaoForEncontrada(){
        DadosParaTesteApiService dados = new DadosParaTesteApiService();

        Time resultado = apiService.timeDaData(LocalDate.of(2000, 1, 1), dados.getTodosOsTimes());
    ...
    public void deveRetornarNuloQuandoAListaForVazia(){
        Time resultado = apiService.timeDaData(data1995, new ArrayList<>());
